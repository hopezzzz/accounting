...
$(document).ready(function ()
{
    ...
    if( isPaid == 'paid' )
    {
        $("#ajaxaddBorrowing").find('input, textarea, select').prop("disabled", true).attr("disabled", true);
        ...
        $(document).find('.content-header h1').html('View Borrowing');
    }
});
...
<div class="content-wrapper" >
    ...
    <?php //echo "<pre>"; echo ($result->fullName); echo "</pre>"; ?>
    <section class="content">
      <div class="step_panel">
        <div class="col-md-6 text-left">
          ...
          <?php }  else{?>
                  <a href="<?php echo site_url();?>borrowings" class="success btn btn-success"> Back</a>
        <?php } ?>
        </div>
        ...
        <div class="row setup-content" id="step-1">
          <div class="col-md-12">
          	<div class="row">
            <?php echo form_open('ajaxaddloan', array('id' => 'ajaxaddBorrowing', 'autocomplete' => 'off')); ?>
              <div class="col-md-6 col-sm-12">
                  <div class="form-group">
                      <label class="form-label"> Borrower Name </label>
                      <input type="text" name="borrowName" class="form-control borrowName" value="<?php if(strlen($result->fullName) > 3) echo ($result->fullName); else echo $result->email; ?>" placeholder="Borrower Name">
                  ...
                  <div id="popover-form" class="hide col-md-8 col-sm-12">
                      <h4 class="text-center">Add New Borrower</h4>
                      <div class="form-group">
                          <input autocomplete="off" id="emaidl" name="email" type="text" placeholder="Enter email" class="form-control">
                      </div>
              ...
              <div class="col-md-6">
                ...
                <input type="hidden" name="borrowType" value="borrowings">
