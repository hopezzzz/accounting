...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row setup-content" id="step-1">
            <?php echo form_open('addCreditorAjax', array('id' => 'add-creditor-form', 'class' => '')); ?>
            <div class="step_panel">
                ...
                <div class="col-md-12">
                    ...
                    </div><input type="hidden" class="form-control" name="creditorRef" value="<?php  echo $result->creditorRef; ?>" >
                  ...
                  <div class="col-md-12">
                    <div class="form-group col-md-4" id="companySelectDiv">
                        ...
                        <?php $debtorsCompanies = getBorrowersCompanies($companyData->companyRef,'borrowerCompanyRef,companyname',3); ?>
                        <select name="creditorCompanyRef" class="form-control" id="companySelect">
                            ...
                            <?php foreach ($debtorsCompanies as $key => $value) {?>
                                <option value="<?php echo $value->borrowerCompanyRef;?>" <?php if($result->creditorCompanyRef == $value->borrowerCompanyRef){?>selected <?php } ?> > <?php echo ucfirst($value->companyname);?></option>
                            <?php }
                        } else {?>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group col-md-4">
                        <label class="control-label">Seller VAT No.</label>
                        <input type="text" class="form-control" name="vatNo" value="<?php if($result->vatNo) { echo $result->vatNo; } ?>" placeholder="Enter Seller VAT No" />
                    </div>
                </div>
                <div class="col-md-6">
