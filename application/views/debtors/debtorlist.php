                    ...
                    <div class="box-header" style="margin-top:10px">
                        ...
                        <div class="box-tools">
                          <div class="col-md-8 text-right">
                            <a href="<?php echo site_url();?>add-debtor" class="btn btn-success"> Add Debtor </a>
                          </div>
                         <div class="col-md-4 pull-right">
                            <div class="input-group input-group-sm col-md-12">
  								<input type="text" id="searchKey" name="searchKey" class="form-control pull-right" placeholder="Search">
  								<div class="input-group-btn">
  									<button data-url="<?php echo site_url('debtors');?>" type="button" id="tableSearchBtn" class="btn btn-default"><i class="fa fa-search"></i></button>
  								</div>
  							</div>
                            </div>
						</div>
