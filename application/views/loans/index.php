                                ...
                                if( $reference == '' ||  $referenceType != 'borrower'){ ?>
                                  <div class="col-sm-2 pull-right">
                                    ...
                                    <div class="text-right">
                                        <a href="<?php echo site_url();?>add-loans" class="btn btn-success"> Add Loans / Advances</a>
                                    </div>
                            <?php   } else {?>
                                    <div class="text-right">
                                    ...
                                    <?php if (!empty($records))
                                    {
                                        foreach ($records as $key => $value) { ?>
                                            <tr id="loans_<?php echo $value->loanRef;?>">
                                                ...
                                                <!-- <td><a href="<?php  echo site_url('update-loan/' . $value->loanRef); ?>"><?php echo $value->email; ?></a></td> -->
