            ...
            <div class="row">
                ...
                <label class="form-label"> Payee Name</label>
                  <div class="form-group">
                      <?php $name = $result->title.' '.$result->firstName.' '.$result->lastName; $name = trim($name); ?>
                        <input class="form-control creditorName" name="payeeName" id="creditorName" value="<?php echo $name;?>"  placeholder="Payee Name">
                        <input type="hidden" id="creditorRef" class="payeeRef do-not-ignore" name="payeeRef" value="<?php if($result->payeeRef) echo $result->payeeRef;?>">
                ...
                <label class="form-label"> Type</label>
                  <div class="form-group">
                    <select class="form-control" name="type">
                      ...
                      <option <?php if($result->transactionType == '1') echo "selected"; ?> value="1">Purchase</option>
                      <option <?php if($result->transactionType == '4') echo "selected"; ?> value="4">Purchase Return</option>
                    </select>
                  </div>
              </div>
              <div class="col-lg-5 col-md-6">
                <label class="form-label"> Purchase Type</label>
                  <div class="form-group">
                    <select class="form-control" id="purchaseType" name="purchaseType">
                      ...
                      <option <?php if($result->purchaseType == '1') echo "selected"; ?> value="1">Service</option>
                      <option <?php if($result->purchaseType == '2') echo "selected"; ?> value="2">Products</option>
                    </select>
                  </div>
              </div>
              </div>
              ...
              <div class="col-md-6">
                  ...
                  <div class="col-md-4 form-group text-right">
                    <input id="boxInvoiceNum" placeholder="INVOICE NO." class="form-control boxInvoiceNum" type="text" name="invoiceNo" value="<?php  if(trim($result->invoiceNo) !=""){ echo ucfirst($result->invoiceNo);}?>">
                  </div>
              </div>
              </div>
              </div>
                      ...
                      <tbody>
                        <?php
                          ...
                          <tr class="dealPack trSrNo<?php echo $i;?>">
                              ...
                              <td>
                                <div class="form-group">
                                  <input type="text" class="oneServiceProductPrice validNumber calculation form-control" name="rate[<?php echo $i-1;?>]"  value="<?php if(trim($value->rate) !="") echo $value->rate;?>">
                                </div>
                              </td>
                              <td>
                              ...
                              <td>
                                  <input type="text" class="productServiceGross price form-control calculation" id="productServiceGross" name="amount[]" value="<?php if(trim($value->amount) !="") echo $value->amount.".00";else echo "0.00"?>" readonly>
                              </td>
                              <td>
              ...
              <div class="col-md-6 pull-right text-right" id="sub-total-panel">
...
<table>
  <tbody>
    <tr id="nextLine" class="hide">
      ...
      <td>
          <div class="form-group">
          <input type="text" class="oneServiceProductPrice validNumber calculation form-control" name="rate[]">
        </div>
      </td>
      <td>
