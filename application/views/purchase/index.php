                        ...
                        <div class="col-md-8 text-right">
                            ...
                            if( $reference == '' ||  $referenceType != 'creditor'){ ?>
                                    <div class="text-right">
                                        ...
                                        <a href="<?php echo site_url();?>add-purchase" class="btn btn-success"> Add Purchase</a>
                                    </div>
                            <?php   } else {?>
                                    <div class="text-right">
                        ...
                        <div class="box-body table-responsive no-padding">
                          <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php if (!empty($records)) {
                                        foreach ($records as $key => $value) { ?>
                                            <tr id="transaction_<?php echo $value->transactionRef;?>">
                                                ...
                                                <td><a href="<?php  echo site_url('update-purchase/' . $value->transactionRef); ?>"><?php echo ucfirst($value->invoiceNo); ?></a></td>
                                                  ...
                                                  <td>
                                                      <div class="btn-group">
                                                          ...
                                                          <ul class="dropdown-menu">
                                                                <li><a href="<?php  echo site_url('update-purchase/' . $value->transactionRef); ?>">Update</a></li>
                                    ...
                                    { ?>
                                        <tr><td align="center" colspan="13">No purchase found.</td></tr>
                              <?php   } ?>
                                </tbody>
                              </table>
