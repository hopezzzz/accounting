                ...
                <div class="box">
                    <div class="box-header" style="margin-top:10px">
                        ...
                        <div class="col-md-8 text-right">
                            ...
                            if( $reference == '' ||  $referenceType != 'debtor'){ ?>
                                <div class="text-right">
                                    <a href="<?php echo site_url();?>add-debtor" class="btn btn-success btn-margin"> Add Debtor</a>
                                    <a href="<?php echo site_url();?>add-sale" class="btn btn-success"> Add Sales</a>
                                </div>
                        <?php   } else {?>
                                <div class="text-right">
                        ...
                        <div class="col-md-4 pull-right">
                            <div class="input-group input-group-sm col-md-12">
                              ...
                              <div class="input-group-btn">
                                <button data-url="<?php echo site_url('sales');?>" type="button" id="tableSearchBtn" class="btn btn-default"><i class="fa fa-search"></i></button>
                              </div>
                          </div>
                          </div>
                    </div>
                      ...
                      <div class="box-body table-responsive no-padding">
                          <table class="table table-hover">
                              ...
                              <tbody>
                                  <?php if (!empty($records)) {
                                      foreach ($records as $key => $value) { ?>
                                          <tr id="transaction_<?php echo $value->transactionRef;?>">
                                              ...
                                              <td><a href="<?php echo site_url('update-sale/' . $value->transactionRef); ?>"><?php echo ucfirst($value->invoiceNo); ?></a></td>
                                  ...
                                  { ?>
                                      <tr><td align="center" colspan="13">No sale found.</td></tr>
                          <?php   } ?>
                              </tbody>
                          </table>
                      </div>
