    ...
    <body class="hold-transition login-page" style="height:unset">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <?php echo form_open('login', array('name' => 'login', 'method' => 'post', 'class' => 'form form-signup', 'id' => "login-form"));
                ?>
          ...
          <!--        <input type="email" class="form-control" placeholder="Email">-->
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 pull-right">
                        <button type="submit" class="btn btn-primary btn-success pull-right">Sign In</button>
                ...
                <a href="<?php echo base_url(); ?>forgotPassword">I forgot my password</a> &nbsp; | &nbsp;<a href="<?php echo base_url(); ?>register" class="text-center">Register a new</a>
