$(document).ready(function ()
{
        ...
        messages:
                {
                    ...
                    "product[]"   : "Product / Service Name is required.",
                    "quantity[]"  : "QTY is required.",
                    "rate[]"      : "Rate is required.",
                    "subcategoryRef[]": "Expense Category is required.",
                    "qtyType[]": "QTY Type is required.",
                    "productRef[]": "QTY Type is required.",
        ...
        messages:
                {
                    ...
                    loanSource: "Loan From is required.",
    ...
    $("#add-share-capital-form").validate({
      ...
      messages:
              {
                  paymentMethod : "Payment Method is required.",
                  payeeName     : "Share Holder Name is required.",
